function doValidate(truck) {
  if(truck!=null){
    ...
    if (truck.axleCount == null || truck.axleCount == "" || truck.axleCount == undefined || truck.axleCount =='选择车轴数') {
      return '请选择车轴数';
    }
    if (truck.crateType == null || truck.crateType == "" || truck.crateType == undefined || truck.crateType=='0') {
      return '请选择货箱型号';
    }
